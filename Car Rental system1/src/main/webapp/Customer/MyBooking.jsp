...
String query = "SELECT  CAR.CARNAME, CAR.CARNUMBER, BOOKING.B_FROM,BOOKING.B_TO,BOOKING.TOTALDAYS,BOOKING.RENT,BOOKING.BOOKINGID,BOOKING.STATUS FROM BOOKING INNER JOIN CAR ON BOOKING.CARID = CAR.CARID WHERE BOOKING.CUSTOMERID = "+session.getValue("id")+"ORDER BY BOOKING.BOOKINGID DESC";
	...
	%>
              ...
              <th scope="row"><%=rs1.getString(7)%></th>
                ...
                <%
                	...
                	{
                		%>
               				<td><a class="btn btn-primary" href="CancelBooking.jsp?id=<%=rs1.getInt(7)%>" role="button">Cancel</a></td>
                		<% 
                	}
                	else
                	{
