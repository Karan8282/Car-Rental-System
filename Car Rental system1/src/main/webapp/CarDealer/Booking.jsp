...
String query = "SELECT  CAR.CARNAME, CAR.CARNUMBER, BOOKING.B_FROM,BOOKING.B_TO,BOOKING.TOTALDAYS,BOOKING.RENT,BOOKING.BOOKINGID,BOOKING.STATUS FROM BOOKING INNER JOIN CAR ON BOOKING.CARID = CAR.CARID WHERE BOOKING.CUSTOMERID = "+session.getValue("id")+"AND CAR.ADDEDBY = "+session.getAttribute("id");
