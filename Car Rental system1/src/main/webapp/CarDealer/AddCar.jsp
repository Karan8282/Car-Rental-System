...
<body>
    ...
    <div>
            <div class="container mt-3">
                    ...
                    <div>
                        <h1>Add Car</h1>
                        <hr style="background-color: green;border: 2px;">
                    </div>
                    ...
                    <div style="flex-direction:column;">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control my-2" id="CarName" name="CarName" placeholder="Car Name">
                        </div>
                        <div class="col-md-4">
                            <label for="CarNumber"><b>Car Number</b></label>
                            <input type="text" class="form-control my-2" id="CarNumber" name="CarNumber"
                                placeholder="Car License Plate No">
                        </div>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="NoOfSeats"><b>Number Of Seats</b></label>
                        <input type="text" class="form-control my-2" id="NoOfSeats" name="NoOfSeats" placeholder="eg: 2,4">
                    </div>
                    <div class="form-group col-md-4">
                        <label for="CarColor"><b>Car Color</b></label>
                        <input type="text" class="form-control my-2" id="CarColor" name="CarColor" placeholder="Color of the car">
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label for="ModelYear"><b>Model Year</b></label>
                            <input type="text" class="form-control my-2" id="ModelYear" name="ModelYear" placeholder="eg: 2015,2011">
                        </div>
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-4 my-2">
                            ...
                            <input type="file" class="form-control my-2" id="CarDocuments"  name="CarDocuments">
                        </div>
                    </div>
                    <div class="form-group col-md-4 my-2">
                        <label for="CarRent"><b>Car rent</b></label>
                        <input type="text" class="form-control my-2" id="CarRent" name="CarRent">
                    </div>
                    ...
                    <input type="hidden" name="user" value="CarDealer"/>
        ...
        <div class="col-md-5" style="display: table-cell;">
            ...
            <div class="form-group col-md-6 my-2">
                ...
                <input type="file" class="form-control my-2" id="Image1" name="Image1">
            </div>
            <div class="form-group col-md-6 my-2">
                <label for="Image2"><b>Image 2</b></label>
                <input type="file" class="form-control my-2" id="Image2" name="Image2">
            </div>
            <div class="form-group col-md-6 my-2">
                <label for="Image3"><b>Image 3</b></label>
                <input type="file" class="form-control my-2" id="Image3" name="Image3">
            </div>
            <div class="form-group col-md-6 my-2">
                <label for="Image4"><b>Image 4</b></label>
                <input type="file" class="form-control my-2" id="Image4" name="Image4">
            </div>
            <div class="form-group col-md-6 my-2">
                <label for="Image5"><b>Image 5</b></label>
                <input type="file" class="form-control my-2" id="Image5" name="Image5">
            </div>
        </div>
        </div>
